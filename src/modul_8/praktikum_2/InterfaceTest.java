...
public class InterfaceTest {
    public static void main(String[] args) {
        ...
        // Test electric car
        ElectricCar eElectricCar = new ElectricCar("Tesla");
        testVehicle(eElectricCar);
        testElectric(eElectricCar);

        System.out.println("\n" + "=".repeat(50) + "\n");

        // Demonstrasi multiple interface implementation
        System.out.println("MULTIPLE INTERFACE DEMO");
        eElectricCar.honk(); // Overridden default method
        eElectricCar.displayBatteryInfo(); // Default method from Electric interface
